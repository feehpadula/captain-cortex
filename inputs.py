...
from preset_manager import PRESET_SWITCH, PAGE_NEXT, PAGE_FIRST, EFFECT_TOGGLE
...
Inputs = [
    ...
    # ── Switch 1 — preset slot 0 da página atual  +  hold: GATE ───────────────
    {
    ...
    # ── Switch DOWN — avança página  +  hold: FX 5 ────────────────────────────
    {
